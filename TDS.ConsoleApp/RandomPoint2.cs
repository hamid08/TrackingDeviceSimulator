...
namespace RandomPathGenerator
{
    ...
    public class Location
    {
        ...
        public static List<Location> GenerateRouteForDevice()
        {
            var sourceLocation = GetRandomLocationInIran();
            var distentionLocation = Location.GetRandomLocationInRadius(sourceLocation, new Random().Next(2500, 55000));

            var dis = Location.GetDistance(sourceLocation, distentionLocation);
            ...
            List<Location> routeLocations = Location.GetLocationsInRoute(london, newYork, count);
